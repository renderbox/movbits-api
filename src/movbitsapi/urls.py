...
api_urls = [
    path(
        "auth/password/reset/",
        core.api.views.PasswordResetView.as_view(),
        name="rest_password_reset",
    ),
    path("auth/verify-2fa", core.api.views.verify_2fa, name="auth-verify-2fa"),
    path(
        "auth/sso-providers",
        core.api.views.sso_providers,
        name="auth-sso-providers",
    ),
    path(
        "auth/google/",
        core.api.social_views.GoogleLoginView.as_view(),
        name="auth-google",
    ),
    path(
        "auth/facebook/",
        core.api.social_views.FacebookLoginView.as_view(),
        name="auth-facebook",
    ),
    path(
        "auth/tiktok/",
        core.api.social_views.TikTokLoginView.as_view(),
        name="auth-tiktok",
    ),
    path(
        "auth/instagram/",
        core.api.social_views.InstagramLoginView.as_view(),
        name="auth-instagram",
    ),
    path(
        "auth/google/connect/",
        core.api.social_views.GoogleConnectView.as_view(),
        name="auth-google-connect",
    ),
    path(
        "auth/facebook/connect/",
        core.api.social_views.FacebookConnectView.as_view(),
        name="auth-facebook-connect",
    ),
    path(
        "auth/tiktok/connect/",
        core.api.social_views.TikTokConnectView.as_view(),
        name="auth-tiktok-connect",
    ),
    path(
        "auth/instagram/connect/",
        core.api.social_views.InstagramConnectView.as_view(),
        name="auth-instagram-connect",
    ),
